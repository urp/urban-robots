...
# include "utk/math/fixed_size/multidim_slice_remove_index.hpp"

#define BOOST_TEST_DYN_LINK
#define BOOST_TEST_MODULE multidim_slice_layout remove_index
...
struct first_fixed
{
  typedef multidim_slice_layout< multidim_layout< size_vector<1,2,3> >, index_vector<0,2,3> > old_layout;
};
...
BOOST_FIXTURE_TEST_SUITE( layout_remove_index, first_fixed )
  ...
  {
    typedef typename remove_index< old_layout, 1 >::type layout;
