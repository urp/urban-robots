/*  generic_layout_test.cpp - Copyright Peter Urban 2012-2013
...
BOOST_AUTO_TEST_SUITE( static_use )
  ...
  {
    typedef generic_layout< size_vector<2,3,4> > layout234;
  ...
  {
    typedef generic_layout< size_vector<2,3,4,5> > layout234;
