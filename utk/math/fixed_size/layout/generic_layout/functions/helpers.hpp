/*  helpers.hpp - Copyright Peter Urban 2012
...
# include "utk/math/fixed_size/layout/index_vector_types.hpp"
...
namespace utk
{
  namespace math
  {
	...
	namespace helpers
	{
	  ...
	  template< >
	  struct stride_sequence< meta::integral::vector< size_type > >
	  {
	    typedef meta::integral::vector< stride_type > type;
	  };
