...
#define BOOST_TEST_MODULE layout_layout add_attributes
...
struct fixture123
{
  typedef generic_layout< size_vector<1,2,3> > layout123;
};

BOOST_FIXTURE_TEST_SUITE( generic_layout_remove_index, fixture123 )
