...
# include "utk/math/fixed_size/layout/generic_layout/functions/product_layout.hpp"

#define BOOST_TEST_DYN_LINK
#define BOOST_TEST_MODULE generic_layout::product_layout
...
BOOST_AUTO_TEST_SUITE( two_dim_x_one_dim )
  ...
  BOOST_AUTO_TEST_CASE( generic_layout_stride )
  {
    typedef generic_layout< size_vector<1> > layout1;
    typedef generic_layout< size_vector<2,3> > layout2;
  ...
  BOOST_AUTO_TEST_CASE( generic_layout_static_offset )
  {
    typedef generic_layout< size_vector<1> > layout1;
    typedef generic_layout< size_vector<2,3> > layout2;
    typedef typename product_layout< layout1, layout2 >::type layout1x2;
