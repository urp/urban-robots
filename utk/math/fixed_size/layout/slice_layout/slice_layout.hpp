  ...
  namespace math
  {
	...
	class slice_layout : public slice_layout_base< FullLayout, FullIndexMask, NewIndexAttributes... >::type
	{
	  ...
	  public:
	    ...
	    typedef typename slice_layout_base< FullLayout, FullIndexMask, NewIndexAttributes... >::type 	     base;
	    typedef typename slice_layout_base< FullLayout, FullIndexMask, NewIndexAttributes... >::visibility_mask  visibility_mask;
