/*  component_iterator_test.cpp - Copyright Peter Urban 2012-2013
...
# define BOOST_TEST_MODULE utk::fixed_size::iterator::fusion::component_iterator
# include <boost/test/unit_test.hpp>

using namespace utk;
using namespace utk::math::fixed_size;
using namespace utk::math::fixed_size::iterator;
...
BOOST_AUTO_TEST_CASE( check_layout3 )
{
  ...
  typedef fusion::component_iterator< type > it0_type;
