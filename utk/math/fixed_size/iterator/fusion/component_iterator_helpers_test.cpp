/*  component_iterator_helpers_test.cpp - Copyright Peter Urban 2012-2013
...
# define BOOST_TEST_MODULE utk::math::fixed_size::iterator::fusion::component_iterator helpers
...
BOOST_AUTO_TEST_SUITE( check_component_iterator_helpers )
/*
  BOOST_AUTO_TEST_CASE( check_index_to_indices )
  {
    ...
    typedef typename iterator::fusion::index_to_indices< str2, 0 >::type i0;
    ...
    typedef typename iterator::fusion::index_to_indices< str2, 1 >::type i1;
    ...
    typedef typename iterator::fusion::index_to_indices< str2, 2 >::type i2;
    ...
    typedef typename iterator::fusion::index_to_indices< str2, 3 >::type i3;
...
*/
  BOOST_AUTO_TEST_CASE( check_advance_digits )
  {
    ...
    // indices (0,0) -> (0,1)
    typedef typename iterator::fusion::advance_digits< i0, s23, 1 >::type i1;
    constexpr index_type i1_0 = meta::integral::at< i1, 0 >::value;
    BOOST_CHECK_EQUAL( i1_0, 0 );
    constexpr index_type i1_1 = meta::integral::at< i1, 1 >::value;
    BOOST_CHECK_EQUAL( i1_1, 1 );
    ...
    // indices (0,1) -> (1,0)
    typedef typename iterator::fusion::advance_digits< i1, s23, 1 >::type i2;
    constexpr index_type i2_0 = meta::integral::at< i2, 0 >::value;
    BOOST_CHECK_EQUAL( i2_0, 1 );
    constexpr index_type i2_1 = meta::integral::at< i2, 1 >::value;
    BOOST_CHECK_EQUAL( i2_1, 0 );
  ...
  BOOST_AUTO_TEST_CASE( check_end_indices )
  {
    ...
    typedef typename meta::integral::make_vector< index_type
                                                 , typename meta::integral::transform< s23
                                                                                     , meta::integral::minus< index_type
                                                                                                            , meta::integral::constant< index_type, 1 > >
                                                                                                            >::type
                                                 >::type i3;

    typedef typename iterator::fusion::advance_digits< i3, s23, 1 >::type iend;
