...
# include "utk/math/fixed_size/interface/tensor/operators/multiply.hpp"
# include "utk/math/fixed_size/interface/tensor/operators/io.hpp"

#define BOOST_TEST_DYN_LINK
#define BOOST_TEST_MODULE utk::math::fixed_size::interface::tensor operator multiply
...
BOOST_FIXTURE_TEST_SUITE( check_multiply, fixture )
  ...
  {
    typedef typename layout::fix_index< contra_layout, 1, 2 >::type fixed_layout;
