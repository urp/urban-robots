/*  product_test.cpp - Copyright Peter Urban 2012-2013
...
# include "utk/math/fixed_size/interface/tensor/functions/product.hpp"

#define BOOST_TEST_DYN_LINK
#define BOOST_TEST_MODULE utk::math::fixed_size::interface::tensor::product
...
{
  typedef layout::generic_layout< size_vector<2> > layout;
