...
namespace utk
{
  namespace math
  {
	...
	namespace tensor
	{
	  ...
	  {
	    typedef typename layout::add_attributes< Layout, variance_vector< VarianceVector... > >::type type;
	  };
	  ...
	  {
	      typedef layout::generic_layout< size_vector< SizeVector... > > plain_layout;
