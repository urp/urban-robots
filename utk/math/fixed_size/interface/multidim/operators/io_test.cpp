...
#define BOOST_TEST_MODULE utk::math::fixed_size::interface::multidim::operator (io)
...
struct fixture
{
  ...
  typedef layout::generic_layout< size_vector< 1,2 > > layout12;
  typedef interface< int, vector::unmanaged_tag, layout12 > type12;
  type12 tensor12;

  typedef layout::generic_layout< size_vector< 1 > > layout1;
  typedef interface< int, vector::unmanaged_tag, layout1 > type1;
  type1  tensor1;


  typedef layout::generic_layout< size_vector< > > layout_;
