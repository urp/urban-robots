...
//
void gl_query::print_gl_attrib(const Glib::RefPtr<const Gdk::GL::Config>& glconfig,
...
//
void gl_query::examine_gl_attrib(const Glib::RefPtr<const Gdk::GL::Config>& glconfig)
{
